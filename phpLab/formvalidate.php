...
?>
    ...
    <table>
    <tr>
        <td colspan="2"><h1 align="center">Application Form</h1></td>
    </tr>
    <tr>
        <td>First Name:</td>
    ...
    <tr>
       <td>Address : </td>
       <td><input tyype="text" name="addrss" value="<?php echo $addrss;?>"></td>
    </tr>
    <tr align="center">
       <td colspan="2"><input type="submit" style="width:100%"></td>
    <tr>
    <tr align="center">
       <td colspan="2"><input type="reset" style="width:100%"></td>
    <tr>
    </form> 
